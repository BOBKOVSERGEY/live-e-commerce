<?php
  ...
  define('DB_NAME', 'live-e-commerce'); // database name
  ...
  define('SITE_TITLE', 'Live eCommerce'); // This will be used if no site title is set
  define('MENU_BRAND', 'L-E-C'); //This is the Brand text in the menu

  define('CURRENT_USER_SESSION_NAME', 'V4TjhPNh42fzdK06'); //session name for logged in user
  define('REMEMBER_ME_COOKIE_NAME', '4PtGZVUn8wATaF6c'); // cookie name for logged in user remember me
